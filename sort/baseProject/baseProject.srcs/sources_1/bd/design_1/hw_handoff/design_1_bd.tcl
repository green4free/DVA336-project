...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.PCW_ACT_APU_PERIPHERAL_FREQMHZ {858} \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {99} \
   CONFIG.PCW_ACT_FPGA2_PERIPHERAL_FREQMHZ {152} \
   CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {198} \
   ...
   CONFIG.PCW_ACT_SPI_PERIPHERAL_FREQMHZ {165} \
   CONFIG.PCW_ACT_TPIU_PERIPHERAL_FREQMHZ {200} \
   CONFIG.PCW_ACT_TTC0_CLK0_PERIPHERAL_FREQMHZ {143} \
   CONFIG.PCW_ACT_TTC0_CLK1_PERIPHERAL_FREQMHZ {143} \
   CONFIG.PCW_ACT_TTC0_CLK2_PERIPHERAL_FREQMHZ {143} \
   CONFIG.PCW_ACT_TTC1_CLK0_PERIPHERAL_FREQMHZ {143} \
   CONFIG.PCW_ACT_TTC1_CLK1_PERIPHERAL_FREQMHZ {143} \
   CONFIG.PCW_ACT_TTC1_CLK2_PERIPHERAL_FREQMHZ {143} \
   CONFIG.PCW_ACT_UART_PERIPHERAL_FREQMHZ {49} \
   CONFIG.PCW_ACT_WDT_PERIPHERAL_FREQMHZ {143} \
   ...
   CONFIG.PCW_CLK1_FREQ {99000000} \
   CONFIG.PCW_CLK2_FREQ {152307693} \
   CONFIG.PCW_CLK3_FREQ {198000000} \
   CONFIG.PCW_CPU_CPU_6X4X_MAX_RANGE {867} \
   CONFIG.PCW_CPU_CPU_PLL_FREQMHZ {1716} \
   ...
   CONFIG.PCW_IO_IO_PLL_FREQMHZ {1980} \
  ...
  # Create instance: sort_ip_0, and set properties
  set sort_ip_0 [ create_bd_cell -type ip -vlnv user.org:user:sort_ip:1.0 sort_ip_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins sort_ip_0/S00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_49M/slowest_sync_clk] [get_bd_pins sort_ip_0/s00_axi_aclk]
  ...
  connect_bd_net -net rst_ps7_0_49M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_49M/peripheral_aresetn] [get_bd_pins sort_ip_0/s00_axi_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sort_ip_0/S00_AXI/S00_AXI_reg] SEG_sort_ip_0_S00_AXI_reg
