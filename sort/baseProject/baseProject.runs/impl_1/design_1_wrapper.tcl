...
set rc [catch {
  ...
  add_files -quiet /home/magnus/Documents/xilinx/newProjectDir/sort/baseProject/baseProject.runs/synth_1/design_1_wrapper.dcp
...
set rc [catch {
  ...
  write_bitstream -force design_1_wrapper.bit -raw_bitfile -bin_file
